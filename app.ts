...
import {DbService} from  "./src/dbService/DbService";
import {Repositories} from "./src/db/repositories/personRepository";
...
var personRepository = new Repositories.PersonRepository();
